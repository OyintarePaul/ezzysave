...
const Overview: React.FC = () => {
    return (
        ...
        <div className="p-4 sm:p-8 space-y-8 pb-20 lg:pb-8"> 
            ...
            <p className="text-gray-600 dark:text-gray-400">Welcome back! Here's a summary of your financial progress.</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 pt-4">
                ...
                <div className="lg:col-span-2 bg-white p-6 rounded-xl shadow-lg border dark:bg-gray-800 dark:border-gray-700">
                    <h2 className="text-xl font-semibold text-gray-900 mb-4 dark:text-white">Active Savings Plans</h2>
                    ...
                    <div className="space-y-4">
                        <div className="flex flex-col sm:flex-row justify-between sm:items-center p-3 border-b dark:border-gray-700">
                            <div>
                                ...
                                <p className="text-sm text-gray-500">Target Savings | $3,200 / $5,000</p>
                            </div>
                            <button className="text-sm text-blue-600 hover:text-blue-700 font-medium mt-2 sm:mt-0">View Progress</button>
                        </div>
                        <div className="flex flex-col sm:flex-row justify-between sm:items-center p-3 border-b dark:border-gray-700">
                            <div>
                                <p className="font-medium text-green-600">Emergency Lockbox</p>
                                <p className="text-sm text-gray-500">Fixed Savings | $5,000 Locked</p>
                            </div>
                            <span className="text-sm text-gray-500 mt-2 sm:mt-0">Matures in 6 mo</span>
                        </div>
                        <div className="flex flex-col sm:flex-row justify-between sm:items-center p-3">
                            <div>
                                <p className="font-medium text-yellow-600">Daily Coffee Budget</p>
                                <p className="text-sm text-gray-500">Daily Savings | $150 remaining</p>
                            </div>
                            <button className="text-sm text-blue-600 hover:text-blue-700 font-medium mt-2 sm:mt-0">Deposit Now</button>
                        </div>
                    </div>
                </div>
...
const OverviewCard: React.FC<OverviewCardProps> = ({ title, value, description, bgColor }) => (
    <div className="p-6 rounded-xl shadow-lg border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
        ...
        <h3 className="text-lg md:text-3xl font-extrabold text-gray-900 mt-1 dark:text-white">{value}</h3>
        <p className="text-xs text-gray-600 mt-2 dark:text-gray-400">{description}</p>
    </div>
);
