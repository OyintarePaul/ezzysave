...
import { mockTransactions, Transaction } from "@/constants/mock";
...
const Transactions = () => {
  ...
  const filterOptions = [
    ...
    { label: "General", icon: <DollarSign className="h-4 w-4 mr-1" /> },
  ];
      ...
      <div className="bg-white p-6 rounded-xl shadow-lg border dark:bg-gray-800 dark:border-gray-700 space-y-4">
        ...
        {filteredTransactions.length > 0 ? (
          ...
          <div className="text-center py-10 text-gray-500 dark:text-gray-400">
            <TrendingUp className="h-10 w-10 mx-auto mb-3 text-indigo-400" />
...
const TransactionItem: React.FC<TransactionItemProps> = ({ transaction }) => {
  ...
  const StatusIcon = transaction.status === "Completed" ? CheckCircle : Clock;
  ...
  return (
    <li className="flex justify-between items-center py-4 border-b last:border-b-0 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition duration-100 px-1">
      ...
      <div className="flex items-center space-x-3 sm:space-x-4 flex-grow min-w-0">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5 space-x-1">
            ...
            <span className="uppercase text-xs font-medium text-indigo-500 dark:text-indigo-400">
      ...
      <div className="text-right flex-shrink-0 ml-4">
        ...
        <p
          className={`flex items-center justify-end text-xs font-medium ${statusColor} dark:opacity-80 mt-1`}
        >
